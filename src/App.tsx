...
function App() {
  ...
  const [widgetFilterProperties, setWidgetSortPropeties] = useState<Array<keyof IWidget>>([]);
  const [peopleFilterProperties, setPeopleSortPropeties] = useState<Array<keyof IPerson>>([]);
